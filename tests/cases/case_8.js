...
const CASE = {
    ...
    stepList: [
        ...
        },
        {
          ...
          params: [ONE_ETHER * 500000n, 1028n + 2880n, 1051200n / 2n],
          value: 0n,
          signerIndex: 2,
        },
        {
    ...
    finalStateCheckList: [
        {
          ...
          signerIndex: 0,
          results: {
            totalFIL: ONE_ETHER * 500000n + 101363557022570715200000n,
            availableFIL: 450000n * ONE_ETHER,
            utilizedLiquidity: 200000n * ONE_ETHER + 101363557022570715200000n - 150000n * ONE_ETHER,
            ...
            accumulatedBorrow: 200000n * ONE_ETHER - ((200000n * ONE_ETHER) * BORROW_FEE_RATE / RATE_BASE),
            accumulatedPayback: 150000n * ONE_ETHER - 101363557022570715200000n,
        ...
        },
        {
          ...
          value: BigInt(0),
          signerIndex: 0,
          results: 5588007526496834235083881n
        },
      ]
}
