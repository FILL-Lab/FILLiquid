...
const CASE = {
    ...
    finalStateCheckList: [
        ...
        },
        {
          ...
          value: 0,
          signerIndex: 0,
          results: [1000000n, REDEEM_FEE_RATE, BORROW_FEE_RATE, 5n, 15n, 14n, 13n, 6n, 99999999999999999999999999999999999999999999999999000000000000000000n, 9223372036854775807n]
        }
      ]
}
